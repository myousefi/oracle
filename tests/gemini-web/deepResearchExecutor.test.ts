...
import { composeGeminiReportMarkdown, normalizeGeminiReport } from '../../src/gemini-web/deepResearchExecutor.js';
      ...
      sources: [
        {
          ...
          links: [
            {
              title: 'amd.com AMD Quark Model Optimization Library Now Available as Open-Source Opens in a new window',
